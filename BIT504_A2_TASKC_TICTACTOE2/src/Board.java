...
public class Board {
	...
	public Board() {
	 ...
	 //DONE: initialise the cells array using ROWS and COLS constants  - DONE
		cells = new Cell [GameMain.ROWS] [GameMain.COLS]; //cells array using CONSTs
	...
	public boolean hasWon (Player thePlayer, int playerRow, int playerCol) {
		...
		if(cells[playerRow][0].content == thePlayer && cells[playerRow][1].content == thePlayer && cells[playerRow][2].content == thePlayer )
		 ...
		 // DONE: Check if the player has 3 in the playerCol.-DONE
		...
		// DONE Check the diagonal in the other direction -DONE
